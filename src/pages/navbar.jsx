...
return(
    ...
    <nav className='bg-gray-800 h-20 ' >
        <div className=' '><button className='bg-white rounded ml-4 mt-6 '  onClick={toggleMenu}> ☰ dashboard </button> <Link to="/login"><button className='bg-white rounded mr-20'>Login</button></Link><Link to ="/"><button className='rounded bg-white mr-10'>SignUp</button></Link></div>
        {isopen && (
            <div className='bg-black  w-40 absolute top-20 left-0' >
                <ul>
                    <li className='text-white p-2'><Link to="/home">Home 🏠</Link></li>
